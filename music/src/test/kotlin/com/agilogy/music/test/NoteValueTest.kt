...
class NoteValueTest : FunSpec({
    ...
    test("Note value relative value") {
        ...
        assertEquals(RelativeValue(1.r / 4), NoteValue.Quarter.relativeValue)
    ...
    test("Syntax: RelativeValue.of should throw IllegalArgumentException when there is no note value for the relative value") {
        assertThrows<IllegalArgumentException> {
            NoteValue.of(RelativeValue(2.r / 3))
        }
    }
